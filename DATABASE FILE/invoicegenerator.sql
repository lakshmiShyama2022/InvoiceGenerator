...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 25, 2022 at 08:12 PM
...
CREATE TABLE `invoice_order` (
  ...
  `order_amount_discount` int(11) NOT NULL,
  `order_amount_after_disc` int(11) NOT NULL,
...
INSERT INTO `invoice_order` (`user_id`, `order_id`, `order_receiver_name`, `order_receiver_address`, `order_total_before_tax`, `order_total_tax`, `order_tax_per`, `order_total_after_tax`, `order_amount_discount`, `order_amount_after_disc`, `order_date`, `note`) VALUES
(1, 7, 'drtwt', 'ytrur', '1031488', '453854.72', '44', '1485342.72', 2423, 1482919, '2022-07-24 23:43:24', 'weds'),
(1, 8, 'arsf', 'adsfhgdhgfsa', '2760', '414', '15', '3174', 200, 2974, '2022-07-25 22:05:00', '');
...
(7, '12', 'vcxbv', '32', '32234', '1031488'),
(8, '2', 'adfgdbv', '12', '230', '2760');
...
(1, 'admin@admin.com', 'e6e061838856bf47e1de730719fb2609', 'test', 'Account', 'test address', 'xxxxxxxxxxxx');
